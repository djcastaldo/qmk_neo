...
// `--------------------------------------------------------------------------------------------------`
   [MAC_BASE] = LAYOUT_hot(
        ...
        KC_LCTL,  KC_LOPT,  KC_LCMD,                 KC_SPC,                TD(RCMD_OSL),  SP_RCTL,      KC_LEFT, KC_DOWN, KC_RGHT),
...
// : |  LShift   || Z  || X  || C  || V  || B  || N  || M  || ,  || .  || /  ||RSFT_TD  || up ||FKEY| :
// : |___________||____||____||____||____||____||____||____||____||____||____||_________||____||____| :
// : |LCtl  ||TDLGui||LAlt ||                Space                ||TRAlt||SRCtl|  | lt || dn || rt | :
// : |______||______||_____||_____________________________________||_____||_____|  |____||____||____| :
// `--------------------------------------------------------------------------------------------------`
    [WIN_BASE] = LAYOUT_hot(
        ...
        TD(CAPSFK_OSL),    KC_A, KC_S, KC_D, KC_F, KC_G, KC_H, KC_J, KC_K, KC_L, KC_SCLN, KC_QUOT,         KC_ENT,          KC_PGDN,
        KC_LSFT,            KC_Z, KC_X, KC_C, KC_V, KC_B, KC_N, KC_M, KC_COMM, KC_DOT, KC_SLSH,    RSFT_TD,        KC_UP,  OSL_FKEY,
        KC_LCTL, TD(LGUI_OSL), KC_LALT,              KC_SPC,              TD(RALT_OSL), SP_RCTL,         KC_LEFT, KC_DOWN, KC_RGHT),
...
// `--------------------------------------------------------------------------------------------------`
    [FKEY_LAYR] = LAYOUT_hot(
        ...
        _______,_______,_______, _______, _______, _______, _______, _______, _______, _______, _______, KC_LPAD, _______, _______,
...
// .--------------------------------------------------------------------------------------------------.
// :  ______________________________________________________________________________________________  :
// : | NO || NO || NO || NO || NO || NO || NO || NO || NO || NO || NO || NO || NO || NO || NO ||ULck| :
// : |____||____||____||____||____||____||____||____||____||____||____||____||____||____||____||____| :
